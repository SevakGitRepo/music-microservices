...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleBadRequest(BadRequestException exception) {
    ...
    return validationErrorResponse(Map.of("request", exception.getMessage()));
  }
  ...
  public ResponseEntity<ErrorResponse> handleNotFound(NotFoundException exception) {
    ...
    return errorResponse(HttpStatus.NOT_FOUND,
        new ErrorResponse(exception.getMessage(), NOT_FOUND_ERROR_CODE, null));
  }
  ...
  public ResponseEntity<ErrorResponse> handleRequestValidation(Exception exception) {
    ...
    if (exception instanceof MethodArgumentTypeMismatchException mismatchException) {
      details.put(mismatchException.getName(), "Invalid value");
    } else if (exception instanceof MissingServletRequestParameterException missingException) {
    ...
    return validationErrorResponse(details.isEmpty() ? Map.of("request", exception.getMessage()) : details);
  }
